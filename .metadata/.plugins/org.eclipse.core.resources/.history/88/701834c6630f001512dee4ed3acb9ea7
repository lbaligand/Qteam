...
public void drawScoreBoard() {
  ...
  scoreboard.text("Velocity: " + mover.getVelocityMagnitude(), 8 * panelHeight / 200, 2.5f * 8 * panelHeight / 50);
...
public void checkCylinderCollision(ArrayList<PVector> a, int cylinderBaseSize, int boxDepth) {
  for(PVector c : a) {
